import { Share2 as ShareIcon, Trash2 as DeleteIcon, Video as YoutubeIcon, MessageSquare as TwitterIcon, CheckCircle, Circle, Pin as PinIcon, Sparkles } from "lucide-react";
            ...
            <div className="flex items-center justify-between p-4 border-b border-ui-border bg-surface-0/80">
                <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-xl bg-surface-2 flex items-center justify-center text-zinc-300 shadow-sm border border-ui-border">
                        {type === "twitter" && <TwitterIcon className="w-4 h-4 text-blue-400" />}
                        {type === "youtube" && <YoutubeIcon className="w-4 h-4 text-red-500" />}
                        {type !== "twitter" && type !== "youtube" && <PinIcon className="w-4 h-4 text-secondary" />}
                    </div>
                ...
                <div className="flex items-center gap-1">
                    ...
                    >
                        {isRead ? <CheckCircle className="w-4 h-4 text-green-400" /> : <Circle className="w-4 h-4" />}
                    </Button>
                    <Button 
                        variant="ghost"
                        size="icon-sm"
